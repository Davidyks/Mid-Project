...
<body>
    <div style="margin: 200px; background-color: azure; padding: 40px">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="Umur" aria-describedby="emailHelp" name="Umur" value="{{ old('Umur') }}">
        </div>
        @error('Umur')
            <p style="color: red">{{ $message }}</p>
        @enderror
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="Telpon" aria-describedby="emailHelp" name="Telpon" value="{{ old('Telpon') }}">
        </div>
        @error('Telpon')
            <p style="color: red">{{ $message }}</p>
        @enderror
